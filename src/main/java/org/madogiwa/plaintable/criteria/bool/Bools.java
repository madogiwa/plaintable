...
public class Bools {
	...
	public static BetweenPredicate between(NumericColumnReference column,
			Number low, Number high) {
		return between(column, new NumericRaw(low), new NumericRaw(high));
	}

	public static BetweenPredicate between(NumericExpression target,
			NumericExpression low, NumericExpression high) {
		return new BetweenPredicate(target, low, high, BetweenType.BETWEEN);
	}

	public static BetweenPredicate between(DateTimeColumnReference column,
			Date low, Date high) {
		return between(column, new DateTimeRaw(low), new DateTimeRaw(high));
	}

	public static BetweenPredicate between(DateTimeExpression target,
			DateTimeExpression low, DateTimeExpression high) {
		return new BetweenPredicate(target, low, high, BetweenType.BETWEEN);
	}

	public static BetweenPredicate notBetween(NumericColumnReference column,
			Number low, Number high) {
		return notBetween(column, new NumericRaw(low), new NumericRaw(high));
	}

	public static BetweenPredicate notBetween(NumericExpression target,
			NumericExpression low, NumericExpression high) {
		return new BetweenPredicate(target, low, high, BetweenType.NOT_BETWEEN);
	}

	public static BetweenPredicate notBetween(DateTimeColumnReference column,
			Date low, Date high) {
		return notBetween(column, new DateTimeRaw(low), new DateTimeRaw(high));
	}

	public static BetweenPredicate notBetween(DateTimeExpression target,
			DateTimeExpression low, DateTimeExpression high) {
		return new BetweenPredicate(target, low, high, BetweenType.NOT_BETWEEN);
	}
	...
	public static ComparisonPredicate eq(ValueExpression lhs,
			ValueExpression rhs) {
		return equal(lhs, rhs);
	}

	public static ComparisonPredicate equal(ValueExpression lhs,
			ValueExpression rhs) {
		return new ComparisonPredicate(lhs, rhs,
	...
	public static ComparisonPredicate ne(ValueExpression lhs,
			ValueExpression rhs) {
		return notEqual(lhs, rhs);
	}

	public static ComparisonPredicate notEqual(ValueExpression lhs,
			ValueExpression rhs) {
		return new ComparisonPredicate(lhs, rhs,
				ComparisonPredicate.Operator.EQUAL);
	}
	...
	public static ComparisonPredicate gt(ValueExpression lhs,
			ValueExpression rhs) {
		return greaterThan(lhs, rhs);
	}

	public static ComparisonPredicate greaterThan(ValueExpression lhs,
			ValueExpression rhs) {
		return new ComparisonPredicate(lhs, rhs,
				ComparisonPredicate.Operator.EQUAL);
	}
	...
	public static ComparisonPredicate ge(ValueExpression lhs,
			ValueExpression rhs) {
		return greaterThanOrEqual(lhs, rhs);
	}

	public static ComparisonPredicate greaterThanOrEqual(ValueExpression lhs,
			ValueExpression rhs) {
		return new ComparisonPredicate(lhs, rhs,
				ComparisonPredicate.Operator.EQUAL);
	}
	...
	public static ComparisonPredicate lt(NumericColumnReference column,
			Number value) {
		return lt(column, value);
	}

	public static ComparisonPredicate lt(ValueExpression lhs,
			ValueExpression rhs) {
		return littleThan(lhs, rhs);
	}

	public static ComparisonPredicate littleThan(ValueExpression lhs,
			ValueExpression rhs) {
		return new ComparisonPredicate(lhs, rhs,
				ComparisonPredicate.Operator.EQUAL);
	}
	...
	public static ComparisonPredicate le(ValueExpression lhs,
			ValueExpression rhs) {
		return littleThanOrEqual(lhs, rhs);
	}

	public static ComparisonPredicate littleThanOrEqual(ValueExpression lhs,
			ValueExpression rhs) {
		return new ComparisonPredicate(lhs, rhs,
				ComparisonPredicate.Operator.EQUAL);
	}
	...
	public static InPredicate in(KeyColumn column, Long[] list) {
		return in(new KeyColumnReference(column),
				new NumericListRaw(Arrays.asList(list)));
	}

	public static InPredicate in(KeyColumnReference column,
			NumericListExpression list) {
		return new InPredicate(column, list);
	}

	public static <N extends Number> InPredicate in(NumericAttribute attr,
			N[] list) {
		return in(new NumericColumnReference(attr),
				new NumericListRaw(Arrays.asList(list)));
	}

	public static InPredicate in(NumericColumnReference column,
			NumericListExpression list) {
		return new InPredicate(column, list);
	}

	public static InPredicate in(TextAttribute attr, String[] values) {
		return in(new StringColumnReference(attr),
				new StringListRaw(Arrays.asList(values)));
	}

	public static InPredicate in(StringExpression value,
	...
	public static InPredicate in(DateTimeAttribute attr, Date[] values) {
		return in(new DateTimeColumnReference(attr),
				new DateTimeListRaw(Arrays.asList(values)));
	}

	public static InPredicate in(DateTimeExpression value,
	...
	public static LikePredicate exact(StringColumnReference column,
			String pattern) {
		return new LikePredicate(column, pattern, LikePredicate.Type.LIKE,
				LikePredicate.MatchType.EXACT);
	}
	...
	public static LikePredicate contain(StringColumnReference column,
			String pattern) {
		return new LikePredicate(column, pattern, LikePredicate.Type.LIKE,
				LikePredicate.MatchType.CONTAIN);
	}
	...
	public static LikePredicate startWith(StringColumnReference column,
			String pattern) {
		return new LikePredicate(column, pattern, LikePredicate.Type.LIKE,
				LikePredicate.MatchType.START_WITH);
	}
	...
	public static LikePredicate endWith(StringColumnReference column,
			String pattern) {
		return new LikePredicate(column, pattern, LikePredicate.Type.LIKE,
				LikePredicate.MatchType.END_WITH);
	}
	...
	public static LikePredicate notExact(StringColumnReference column,
			String pattern) {
		return new LikePredicate(column, pattern, LikePredicate.Type.NOT_LIKE,
				LikePredicate.MatchType.EXACT);
	}
	...
	public static LikePredicate notContain(StringColumnReference column,
			String pattern) {
		return new LikePredicate(column, pattern, LikePredicate.Type.NOT_LIKE,
				LikePredicate.MatchType.CONTAIN);
	}
	...
	public static LikePredicate notStartWith(StringColumnReference column,
			String pattern) {
		return new LikePredicate(column, pattern, LikePredicate.Type.NOT_LIKE,
				LikePredicate.MatchType.START_WITH);
	}
	...
	public static LikePredicate notEndWith(StringColumnReference column,
			String pattern) {
		return new LikePredicate(column, pattern, LikePredicate.Type.NOT_LIKE,
				LikePredicate.MatchType.END_WITH);
	}
	...
	public static QuantifiedPredicate equalAll(ValueExpression value,
			ValueListExpression list) {
		return new QuantifiedPredicate(value, list, Quantified.ALL,
				Operator.EQUAL);
	}

	public static QuantifiedPredicate equalSome(ValueExpression value,
			ValueListExpression list) {
		return new QuantifiedPredicate(value, list, Quantified.SOME,
				Operator.EQUAL);
	}

	public static QuantifiedPredicate equalAny(ValueExpression value,
			ValueListExpression list) {
		return new QuantifiedPredicate(value, list, Quantified.ANY,
				Operator.EQUAL);
	}

	public static QuantifiedPredicate notEqualAll(ValueExpression value,
			ValueListExpression list) {
		return new QuantifiedPredicate(value, list, Quantified.ALL,
				Operator.NOT_EQUAL);
	}

	public static QuantifiedPredicate notEqualSome(ValueExpression value,
			ValueListExpression list) {
		return new QuantifiedPredicate(value, list, Quantified.SOME,
				Operator.NOT_EQUAL);
	}

	public static QuantifiedPredicate notEqualAny(ValueExpression value,
			ValueListExpression list) {
		return new QuantifiedPredicate(value, list, Quantified.ANY,
				Operator.NOT_EQUAL);
	}

	public static QuantifiedPredicate littleThanAll(ValueExpression value,
			ValueListExpression list) {
		return new QuantifiedPredicate(value, list, Quantified.ALL,
				Operator.LITTLE_THAN);
	}

	public static QuantifiedPredicate littleThanSome(ValueExpression value,
			ValueListExpression list) {
		return new QuantifiedPredicate(value, list, Quantified.SOME,
				Operator.LITTLE_THAN);
	}

	public static QuantifiedPredicate littleThanAny(ValueExpression value,
			ValueListExpression list) {
		return new QuantifiedPredicate(value, list, Quantified.ANY,
				Operator.LITTLE_THAN);
	}

	public static QuantifiedPredicate littleThanOrEqualAll(
			ValueExpression value, ValueListExpression list) {
		return new QuantifiedPredicate(value, list, Quantified.ALL,
				Operator.LITTLE_THAN_OR_EQUAL);
	}

	public static QuantifiedPredicate littleThanOrEqualSome(
			ValueExpression value, ValueListExpression list) {
		return new QuantifiedPredicate(value, list, Quantified.SOME,
				Operator.LITTLE_THAN_OR_EQUAL);
	}

	public static QuantifiedPredicate littleThanOrEqualAny(
			ValueExpression value, ValueListExpression list) {
		return new QuantifiedPredicate(value, list, Quantified.ANY,
				Operator.LITTLE_THAN_OR_EQUAL);
	}

	public static QuantifiedPredicate greaterThanAll(ValueExpression value,
			ValueListExpression list) {
		return new QuantifiedPredicate(value, list, Quantified.ALL,
				Operator.GREATER_THAN);
	}

	public static QuantifiedPredicate greaterThanSome(ValueExpression value,
			ValueListExpression list) {
		return new QuantifiedPredicate(value, list, Quantified.SOME,
				Operator.GREATER_THAN);
	}

	public static QuantifiedPredicate greaterThanAny(ValueExpression value,
			ValueListExpression list) {
		return new QuantifiedPredicate(value, list, Quantified.ANY,
				Operator.GREATER_THAN);
	}

	public static QuantifiedPredicate greaterThanOrEqualAll(
			ValueExpression value, ValueListExpression list) {
		return new QuantifiedPredicate(value, list, Quantified.ALL,
				Operator.GREATER_THAN_OR_EQUAL);
	}

	public static QuantifiedPredicate greaterThanOrEqualSome(
			ValueExpression value, ValueListExpression list) {
		return new QuantifiedPredicate(value, list, Quantified.SOME,
				Operator.GREATER_THAN_OR_EQUAL);
	}

	public static QuantifiedPredicate greaterThanOrEqualAny(
			ValueExpression value, ValueListExpression list) {
		return new QuantifiedPredicate(value, list, Quantified.ANY,
				Operator.GREATER_THAN_OR_EQUAL);
	}
